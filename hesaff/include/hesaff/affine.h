...
struct AffineShapeParams
{
    ...
    // convergence threshold, i.e. maximum deviation from isotropic shape at
    // convergence
...
struct AffineShapeCallback
{
    virtual void onAffineShapeFound(
        ...
        float a21, float a22, int type, float response, int iters) = 0;
};
...
struct AffineShape
{
  public:
    ...
    // fills patch with affine normalized neighbourhood around point in the img,
    // enlarged mrSize times
